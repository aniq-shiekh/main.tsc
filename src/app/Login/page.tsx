...
function Login() {
  ...
  return (
    <div className="flex flex-col sm:flex-row min-h-screen">
      {/* Left Section (Image) */}
      <div className="w-full sm:w-1/2 flex justify-center bg-blue-400 items-center p-4">
        <Image
          src="/f1.png"
          alt="Cart"
      ...
      <div className="w-full sm:w-1/2 flex justify-center items-center bg-white p-6 sm:p-12">
        <div className="w-full max-w-md">
          <h1 className="text-3xl sm:text-4xl text-blue-400 font-bold text-center mb-2">Log in to Exclusive</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              <button
                type="submit"
                className="w-full sm:w-auto px-6 py-2 bg-blue-400 text-white font-semibold rounded-md hover:bg-red-600"
              >
                Log In
              </button>
              <a href="#" className="text-sm text-purple-800 hover:text-red-700 text-center">
                Forgot Password?
              </a>
            </div>
          </form>
